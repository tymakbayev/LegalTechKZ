"""
LegalTechKZ - Legal Expert System for Kazakhstan NPA
Main entry point for the LegalTechKZ framework
"""

import argparse
import sys
from legaltechkz.core.orchestrator import AgentOrchestrator
from legaltechkz.ui.cli import CLI

def main():
    """Main entry point for the LegalTechKZ Legal Expert System"""
    parser = argparse.ArgumentParser(description="LegalTechKZ - Legal Expert System for Kazakhstan NPA")
