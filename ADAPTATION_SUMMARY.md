...
## Цель адаптации
Адаптация фреймворка (Autonomous Networked Utility System) для проведения правовой экспертизы нормативно-правовых актов Республики Казахстан с использованием **исключительно** официального ресурса **adilet.zan.kz**.
